...
const Onboarding = () => {
  ...
  const handleSaveBtnClick = (event) => {
    ...
    if (isAuthenticated && user && !user.email_verified) {
      setErrorAlert(<ErrorAlert message="Please verify your email address." />);
      return;
    }
  };
  ...
  //   return <Loading />; // render the Loading component if isLoading is true or user.email_verified is false
  // }
